...
define(['dojo/_base/declare',
  ...
  function(declare, lang, array, html, baseFx, on, has, touch,
    ...
    =====*/
      ...
      closeAction:"destroy",//valid values would be "destroy","hide"
      onShow: null,
      onHide:null,
      modal:true,
      ...
      showPopup: function () {
          if (!(this.domNode)) {
              console.log("Popup is destroyed.Hence this method is not valid.");
              return;
          }
          if (!(this.showing)) {
      ...
      close: function() {
          if (this.onClose && this.onClose() === false) {
              return;
          } else if (this.closeAction === 'destroy') {
              this.destroyPopup()
          } else {
              this.hidePopup();
          }
