...
/*GBS customised this module to display row text editors when edit button is clicked..
 edited methods:
       _createEditableTextTd
       _editEditableText
 added methods
        _hideRowEditor,
        finishEditing
      ...
      */
      ...
      _createEditableTextTd: function(tr, fieldMeta, fieldData) {
        ...
        this.own(on(editableDiv, 'dblclick', lang.hitch(this, function(event) {
          ...
          this.finishEditing();//gbs customization
          editableInput.value = editableDiv.innerHTML;
      ...
      _editEditableText: function(td, fieldMeta, fieldData) {
        ...
        html.setStyle(editableDiv, 'display', 'none');//gbs customization
      ...
      _hideRowEditor:function(tr){
          var tds = query('.simple-table-cell', tr);
          array.forEach(tds, function (td) {
              /*jshint unused: false*/
              var editableDiv = query('div', td)[0];
              var editableInput = query('input', td)[0];
              if (editableInput) {
