...
function(declare, html, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin,
  template, lang, array, on, query, Deferred,scriptRequest, domStyle,domAttr, Evented,
  ...
  return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
    ...
    _updateFeatureZoomSelector: function () {
    ...
    _getGeometryOfResultFeature: function () {
        ...
        var serviceUrl = this.sourceUrl.get("value");
        if (serviceUrl) {
    ...
    _onSetSourceClick: function() {
      ...
      on.once(featurePopup, 'ok', lang.hitch(this, function(item) {
        ...
        featurePopup = null;
        this._updateFeatureZoomSelector();
