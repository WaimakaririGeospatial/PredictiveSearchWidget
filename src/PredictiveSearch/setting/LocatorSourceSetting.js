  ...
  function(
    ...
    return declare([
      ...
      setFeatureZoomSelector: function () {
          ...
          if (config.hasOwnProperty("zoomMethod") && config["zoomMethod"] && config.zoomMethod.zoomToScale) {
              this._showZoomToScaleSelector();
          } else if (config.hasOwnProperty("zoomMethod") && config["zoomMethod"] && config.zoomMethod.zoomToFeature) {
              this._showZoomToFeatureSelector();
          } else {
              var geomType = this._getGeometryOfResultFeature();
      ...
      _getGeometryOfResultFeature:function(){
          ////Geocoder returns only points,
          //for other searches query the service and find out the geometry type
